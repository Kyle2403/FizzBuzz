...
const Page =  () => {
  ...
  return (
    <div className='flex flex-col min-h-screen'>
        ...
        <div className='flex flex-col flex-grow 2xl:w-5/6 2xl:mx-auto'>
          ...
          <div className='flex flex-col w-1/3 items-center mx-auto'>
            <input type="text" value = {input} onKeyDown={(e) => e.key === "Enter" && handleSubmit()} onChange = {(e)=> setInput(e.target.value)} placeholder="Type your answer..." className="input input-xl text-center w-full text-white input-bordered mt-20 rounded-lg" />
            <p className="text-sm italic text-gray-400">Press Enter to submit</p>
          </div>

        </div>
        
        <button className='btn btn-info btn-xl shadow-md' onClick={endSession}>End Game</button>
        <Footer></Footer>
    </div>
  )
}
