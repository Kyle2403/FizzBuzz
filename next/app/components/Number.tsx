...
const Number = ({number}: NumberProps) => {
  return (
    <div className='w-fit flex flex-col items-center mx-auto '>
        <h1 className='text-4xl font-bold mb-4'>Current Number</h1>
        <div className='font-bold text-9xl text-cyan-800 border-4 border-base-300 rounded-lg p-4 mx-auto'>{number}</div>
    </div>
  )
}
