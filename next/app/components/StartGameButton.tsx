          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 w-96">
            ...
            <div className="mb-3">
              ...
              <input
                ...
                className="text-white w-full border rounded-lg p-2"
            ...
            <p className='font-light italic text-xs mb-3'>*Make sure to read the rules before starting, they wont be displayed during the game session.</p>
