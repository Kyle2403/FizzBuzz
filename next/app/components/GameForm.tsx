...
const GameForm = () => {
  ...
  return (
    <div className="flex justify-center">
      <fieldset className="fieldset w-full max-w-3xl border border-base-300 rounded-box p-4 m-4">
        <legend className="fieldset-legend font-bold text-black text-xl xl:text-2xl">Create a New Game</legend>

        <label className="label text-lg xl:text-lg">Game Name</label>
        <input
        ...
        <label className="label text-lg xl:text-lg">Your Name</label>
        <input
        ...
        <label className="label text-lg xl:text-lg">Range</label>
        ...
        <label className="label text-lg xl:text-lg">Rules</label>
          ...
          {rules.map((rule, index) => (
            <div key={index} className="flex  items-center gap-4 mb-4">
              <input
                ...
                required
                className="flex-grow bg-gray-100 input xl:input-md"
                placeholder="Divisor"
                value={rule.divisor}
              />
              <input
              ...
              <button
                ...
                type="button"
                className="btn bg-white border-none shadow-none btn-square  btn-sm 2xl:btn-lg flex items-center justify-center"
              >
